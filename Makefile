...
EXE_NAME:=$(notdir $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST)))))

# Output
BINS  := $(addprefix $(BUILD_DIR)/,$(EXE_NAME))
CLEAN := $(addprefix clean_,$(EXE_NAME))
...
$(eval $(call template_mk,$(EXE_NAME),$(SRC_DIR)))
